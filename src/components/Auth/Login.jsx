  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <motion.div 
        ...
        className="w-full max-w-4xl bg-white shadow-lg rounded-3xl overflow-hidden border border-gray-200"
      >
        <div className="flex flex-col lg:flex-row">
          <div className="lg:w-5/12 p-8 bg-gradient-to-b from-gray-100 to-gray-200 flex flex-col justify-center">
            <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }} className="text-center lg:text-left">
              <h1 className="text-3xl font-bold text-gray-800 mb-4">PlanIt</h1>
              <h2 className="text-xl font-semibold text-gray-700 mb-4">Welcome Back</h2>
              <p className="text-gray-600 mb-6">Start your professional journey with us today.</p>
            ...
            <form onSubmit={handleSubmit(login)} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 text-gray-800 focus:border-blue-500 focus:ring-blue-500 focus:ring-1 focus:bg-white transition-all duration-200"
